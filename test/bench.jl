...
# ╔═╡ 8d8ae06c-49d6-11ec-34c3-a18dcc073dfa
begin
	using Revise
	import Pkg
	Pkg.develop(path="..")
...
# ╔═╡ 94cc60dd-d9ad-4c47-adb5-a7b314b2409d
using Dates

# ╔═╡ cfbb4fc5-0423-4bc6-b2b4-de4bea054734
using PlutoMy

# ╔═╡ 909878e7-64af-4fb9-b227-05584393c826
using ProfileSVG

# ╔═╡ 4f723d31-6cb7-45bb-84a9-d7314ed1de8f
db = SQLite.DB()

# ╔═╡ c9f6e16b-a4d1-4f41-a77b-bc2184bf7896
...
for i in 1:10^5
	push!(tbl, (a=i, b="xyz $i", c=Dict("key" => "value $i"), d=DateTime(2020, 1, 2, 3, 4) + Second(i) ))
end
...
git-tree-sha1 = "03cc309eeda6e4756b63b9ec91eceaa5d45b7592"
...
[[deps.SQLStore]]
deps = ["DBInterface", "DataAPI", "DataPipes", "Dates", "InvertedIndices", "JSON3", "SQLite", "Tables"]
